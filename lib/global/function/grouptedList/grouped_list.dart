...
class _StickyGroupedListViewState<T, E>
  ...
  Widget build(BuildContext context) {
    ...
    // _isSeparator = widget.reverse ? (int i) => i.isEven : (int i) => i.isOdd;
      ...
      children: <Widget>[
        ScrollablePositionedList.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (index == hiddenIndex) {
              return widget.groupSeparatorBuilder(_sortedElements[actualIndex]);
            }
            ...
            if (_isSeparator(index)) {
              ...
              var currS = curr.toString().substring(0, 10);
              var prevS = prev.toString().substring(0, 10);

              if (currS != prevS) {
                // return Text(currS.toString());
...
class GroupedItemScrollController extends ItemScrollController {
  ...
  @override
  void jumpTo(
      {int index, double alignment = 0, bool automaticAlignment = true}) {
